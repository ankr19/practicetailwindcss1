        ...
        <li className="relative group px-3 py-2">
          ...
          <div
            ...
            <div className="relative top-6 p-6 bg-black rounded-xl shadow-xl w-full">
              <div
                className="w-10 h-10 bg-black transform rotate-45 absolute top-0 z-0 translate-x-0 transition-transform group-hover:translate-x-[12rem] duration-500 ease-in-out rounded-sm">
              </div>
      ...
      <ul>
        <li>
          <a href="#" className="rounded-full px-3 py-2 font-semibold bg-white bg-opacity-10 flex items-center group">
            ...
            <svg className="stroke-current" width="10" height="10" stroke-width="2" viewBox="0 0 10 10" aria-hidden="true">
              <g fill-rule="evenodd">
